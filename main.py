...
# XATONI TUZATISH: Qurilma sozlamalarini xavfsiz yuklash
def setup_instagram():
    try:
        # Eski sessiya bo'lsa yuklash
        if os.path.exists(SESSION_FILE):
            cl.load_settings(SESSION_FILE)
            logger.info("Sessiya yuklandi.")
        
        # Login qilish (set_device_settings xatosi olib tashlandi)
